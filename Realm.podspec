Pod::Spec.new do |s|
  ...
  s.source                  = { :git => "https://github.com/Realm/realm-cocoa.git", :branch => 'tg-podspec' } # , :tag => "v#{s.version}" }
